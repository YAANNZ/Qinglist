...
- (void)addSubviews
{
    ...
    UISegmentedControl *sgControl = [[UISegmentedControl alloc] initWithItems:@[@"搜索发现", @"我的轻单"]];
...
- (void)menuBtnClick
{
    if ([self.delegate respondsToSelector:@selector(bottomViewForMenuButtonClick)])
    {
        [self.delegate bottomViewForMenuButtonClick];
    }
}
